...
public class MainMenuScreen extends BaseScreen {
	...
	public MainMenuScreen() {
		...
		// Background
		Image background = new Image(Xcars.getInstance().assets.getGraphics(Constants.menu.MAIN_MENU_BACKGROUND));
		...
		this.buttonPlay = new ScreenAdaptiveButton(
			...
			public void action() {
				...
				Xcars.difficultySelectScreen = new ScenarioSelectScreen(Xcars.playedLevels.levels.entrySet().size() - 1);
		...
		this.buttonTooltips = new ScreenAdaptiveButton(Xcars.getInstance().assets.getGraphics(tooltipsTexture),
			...
			public void action() {
				...
				if (Xcars.settings.isShowTooltips()) {
					buttonTooltips.setStyle(
							Xcars.getInstance().assets.getGraphics(Constants.menu.BUTTON_MENU_TOOLTIPS_ON),
							Xcars.getInstance().assets.getGraphics(Constants.menu.BUTTON_MENU_TOOLTIPS_ON_HOVER));
				} else {
					buttonTooltips.setStyle(
							Xcars.getInstance().assets.getGraphics(Constants.menu.BUTTON_MENU_TOOLTIPS_OFF),
							Xcars.getInstance().assets.getGraphics(Constants.menu.BUTTON_MENU_TOOLTIPS_OFF_HOVER));
				}
			}
		};
		...
		this.buttonSounds = new ScreenAdaptiveButton(Xcars.getInstance().assets.getGraphics(soundsTexture),
			...
			public void action() {
				...
				if (Xcars.settings.isPlaySounds()) {
					buttonSounds.setStyle(Xcars.getInstance().assets.getGraphics(Constants.menu.BUTTON_MENU_SOUNDS_ON),
							Xcars.getInstance().assets.getGraphics(Constants.menu.BUTTON_MENU_SOUNDS_ON_HOVER));
				} else {
					buttonSounds.setStyle(
							Xcars.getInstance().assets.getGraphics(Constants.menu.BUTTON_MENU_SOUNDS_OFF),
							Xcars.getInstance().assets.getGraphics(Constants.menu.BUTTON_MENU_SOUNDS_OFF_HOVER));
				}
			}
		};
		...
		this.buttonMusic = new ScreenAdaptiveButton(Xcars.getInstance().assets.getGraphics(musicTexture),
			...
			public void action() {
				...
				if (Xcars.settings.isPlayMusic()) {
					buttonMusic.setStyle(Xcars.getInstance().assets.getGraphics(Constants.menu.BUTTON_MENU_MUSIC_ON),
							Xcars.getInstance().assets.getGraphics(Constants.menu.BUTTON_MENU_MUSIC_ON_HOVER));
					Xcars.getInstance().assets.soundAndMusicManager.playMenuMusic();
				} else {
					buttonMusic.setStyle(Xcars.getInstance().assets.getGraphics(Constants.menu.BUTTON_MENU_MUSIC_OFF),
							Xcars.getInstance().assets.getGraphics(Constants.menu.BUTTON_MENU_MUSIC_OFF_HOVER));

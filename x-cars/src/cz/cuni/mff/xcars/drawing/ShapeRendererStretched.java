...
public class ShapeRendererStretched extends ShapeRenderer {
	...
	public void line(float x, float y, float z, float x2, float y2, float z2,
			Color c1, Color c2) {
		super.line(x * Input.xStretchFactorInv, y * Input.yStretchFactorInv, z,
				x2 * Input.xStretchFactorInv, y2 * Input.yStretchFactorInv, z2,
				c1, c2);
	}

	@Override
	public void rectLine(float x1, float y1, float x2, float y2, float width) {
		super.rectLine(x1 * Input.xStretchFactorInv, y1
				* Input.yStretchFactorInv, x2 * Input.xStretchFactorInv, y2
				* Input.yStretchFactorInv, width

...
public final class Sounds {
	...
	//
	//
	public final String MUSIC_MENU = "exciting_race_tune.mp3";
	public final String MUSIC_RACE = "sports_card.mp3";
	...
	public final String SOUND_SUB1_CHEER = "sfx/sounds/sublevels/smallCheer.mp3";

	public final String SOUND_SUB2_CHEER = "sfx/sounds/sublevels/bigCheer.mp3";
	public final float SOUND_SUB2_CHEER_VOLUME = 0.8f;

	public final String SOUND_SUB1_FAIL = "sfx/sounds/sublevels/sports_arena_oh.mp3";

	public final String SOUND_SUB2_START = "sfx/sounds/sublevels/auto_car_rev_up_squeal_away.mp3";

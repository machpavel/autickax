...
public class PauseDialog extends DecisionDialog{
	...
	public PauseDialog(GameScreen gameScreen, SubLevel subLevel) {
		super(gameScreen, subLevel, Constants.GAME_PAUSED, true);
					...
					public void action() {
						...
						if (Autickax.settings.showTooltips) {
							buttonTooltips.setStyle(
									Autickax.getInstance().assets.getGraphics(Constants.BUTTON_MENU_TOOLTIPS_ON),
									Autickax.getInstance().assets.getGraphics(Constants.BUTTON_MENU_TOOLTIPS_ON_HOVER)
							);
						}
						else {
							buttonTooltips.setStyle(
									Autickax.getInstance().assets.getGraphics(Constants.BUTTON_MENU_TOOLTIPS_OFF),
									Autickax.getInstance().assets.getGraphics(Constants.BUTTON_MENU_TOOLTIPS_OFF_HOVER)
							);
						}
					}
				};
					...
					public void action() {
						...
						if (Autickax.settings.playSounds) {
							buttonSounds.setStyle(
									Autickax.getInstance().assets.getGraphics(Constants.BUTTON_MENU_SOUNDS_ON),
									Autickax.getInstance().assets.getGraphics(Constants.BUTTON_MENU_SOUNDS_ON_HOVER)
							);
						}
						else {
							buttonSounds.setStyle(
									Autickax.getInstance().assets.getGraphics(Constants.BUTTON_MENU_SOUNDS_OFF),
									Autickax.getInstance().assets.getGraphics(Constants.BUTTON_MENU_SOUNDS_OFF_HOVER)
							);
						}
					}
				};
					...
					public void action() {
						...
						if (Autickax.settings.playMusic) {
							buttonMusic.setStyle(
									Autickax.getInstance().assets.getGraphics(Constants.BUTTON_MENU_MUSIC_ON),
									Autickax.getInstance().assets.getGraphics(Constants.BUTTON_MENU_MUSIC_ON_HOVER)
							);
							Autickax.getInstance().assets.soundAndMusicManager.playRaceMusic();
						}
						else {
							buttonMusic.setStyle(
									Autickax.getInstance().assets.getGraphics(Constants.BUTTON_MENU_MUSIC_OFF),
									Autickax.getInstance().assets.getGraphics(Constants.BUTTON_MENU_MUSIC_OFF_HOVER)
							);

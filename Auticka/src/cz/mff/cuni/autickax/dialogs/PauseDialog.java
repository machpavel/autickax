					...
					public void action() {
						...
						if (Autickax.settings.showTooltips) {
							buttonTooltips.setStyle(
									Autickax.getInstance().assets.getGraphics(Constants.menu.BUTTON_MENU_TOOLTIPS_ON),
									Autickax.getInstance().assets.getGraphics(Constants.menu.BUTTON_MENU_TOOLTIPS_ON_HOVER)
							);
						}
						else {
							buttonTooltips.setStyle(
									Autickax.getInstance().assets.getGraphics(Constants.menu.BUTTON_MENU_TOOLTIPS_OFF),
									Autickax.getInstance().assets.getGraphics(Constants.menu.BUTTON_MENU_TOOLTIPS_OFF_HOVER)
							);
						}
					}
				};
				this.buttonTooltips.setPosition(Constants.dialog.PAUSE_DIALOG_TOOLTIPS_POSITION_X * Input.xStretchFactor, Constants.dialog.PAUSE_DIALOG_TOOLTIPS_POSITION_Y * Input.yStretchFactor);
					...
					public void action() {
						...
						if (Autickax.settings.playSounds) {
							buttonSounds.setStyle(
									Autickax.getInstance().assets.getGraphics(Constants.menu.BUTTON_MENU_SOUNDS_ON),
									Autickax.getInstance().assets.getGraphics(Constants.menu.BUTTON_MENU_SOUNDS_ON_HOVER)
							);
						}
						else {
							buttonSounds.setStyle(
									Autickax.getInstance().assets.getGraphics(Constants.menu.BUTTON_MENU_SOUNDS_OFF),
									Autickax.getInstance().assets.getGraphics(Constants.menu.BUTTON_MENU_SOUNDS_OFF_HOVER)
							);
						}
					}
				};
				this.buttonSounds.setPosition(Constants.dialog.PAUSE_DIALOG_SOUNDS_POSITION_X * Input.xStretchFactor, Constants.dialog.PAUSE_DIALOG_SOUNDS_POSITION_Y * Input.yStretchFactor);
					...
					public void action() {
						...
						if (Autickax.settings.playMusic) {
							buttonMusic.setStyle(
									Autickax.getInstance().assets.getGraphics(Constants.menu.BUTTON_MENU_MUSIC_ON),
									Autickax.getInstance().assets.getGraphics(Constants.menu.BUTTON_MENU_MUSIC_ON_HOVER)
							);
							Autickax.getInstance().assets.soundAndMusicManager.playRaceMusic();
						}
						else {
							buttonMusic.setStyle(
									Autickax.getInstance().assets.getGraphics(Constants.menu.BUTTON_MENU_MUSIC_OFF),
									Autickax.getInstance().assets.getGraphics(Constants.menu.BUTTON_MENU_MUSIC_OFF_HOVER)
							);
							Autickax.getInstance().assets.soundAndMusicManager.stopAllMusic();
						}
					}
				};
				this.buttonMusic.setPosition(Constants.dialog.PAUSE_DIALOG_MUSIC_POSITION_X * Input.xStretchFactor, Constants.dialog.PAUSE_DIALOG_MUSIC_POSITION_Y * Input.yStretchFactor);
